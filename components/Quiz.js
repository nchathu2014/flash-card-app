...
class Quiz extends Component {
    ...
    /**
     * Show the UI related to the Correct Answer
     * @returns {*}
     */
    showCorrectAnswer = () => (<Text style={[styles.answerSpoiled, {color: lightGreen}]}>{Correct}</Text>)

    /**
     * Show the UI related to the In-Correct Answer
     * @returns {*}
     */
            ...
            <View>
                ...
                <View style={{
                    ...
                    <Text style={{textAlign: "center", fontSize: 19}}> <Text
                        style={styles.ResultNum}>{totalCorrect}</Text> out of <Text
                        style={styles.ResultNum}>{count}</Text></Text>
                </View>
